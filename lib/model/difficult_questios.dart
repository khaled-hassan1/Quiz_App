...
final List<Question> qMododDifficult = [
  Question(
...
final List<Question> qNoonDifficult = [
  Question(
...
final List<Question> qMeemDifficult = [
  Question(
...
final List<Question> qtajweedDifficult = [
  Question(
...
final List<Question> qlamDifficult = [
  // Question(
...
final List<Question> qMethlanDifficult = [
  Question(
      question: 'قل لكم',
...
final List<Question> qTafkhemDifficult = [
  Question(
...
final List<Question> mixAllDifficult = [
  ...qMeemDifficult,
  ...qMethlanDifficult,
  ...qMododDifficult,
  ...qNoonDifficult,
